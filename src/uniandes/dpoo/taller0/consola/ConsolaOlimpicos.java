...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país que al cual representa el atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	private void ejecutarBusquedaAtletaPorPais()
	{
		System.out.println("\n" + "Buscar pais que representa el atleta" + "\n");
		
		String atleta = input("Por favor ingrese el nombre del atleta");
		String pais = calculadora.atletaPais(atleta);
		if (pais == null)
		{
		...
		{
			System.out.println("El atleta "+ atleta +" representa "+ pais);
		}	
	}
	/**
